const toggleButton = document.getElementById("tbnColorChanger");


function colorTextChanger() {
    if (toggleButton.textContent === "Red") {
      toggleButton.textContent = "Dark";
    } else {
      toggleButton.textContent = "Red";
    }
  }
  ...
  function toggleTheme() {
    ...
    if (body.classList.contains("darkTheme")) {
      ...
      body.classList.add("redTheme");
    } else {
      body.classList.remove("redTheme");
